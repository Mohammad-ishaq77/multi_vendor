...
export default function DeliveryProfile() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="border-t border-gray-100 pt-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm"><ShieldCheck className="w-4 h-4 text-emerald-500" /><span className="text-gray-700">Identity</span><span className="ml-auto text-emerald-600 font-semibold text-xs bg-emerald-50 px-2 py-0.5 rounded-full">Verified</span></div>
              <div className="flex items-center gap-2 text-sm"><ShieldCheck className="w-4 h-4 text-emerald-500" /><span className="text-gray-700">Address</span><span className="ml-auto text-emerald-600 font-semibold text-xs bg-emerald-50 px-2 py-0.5 rounded-full">Verified</span></div>
              <div className="flex items-center gap-2 text-sm"><ShieldCheck className="w-4 h-4 text-emerald-500" /><span className="text-gray-700">Application</span><span className="ml-auto text-emerald-600 font-semibold text-xs bg-emerald-50 px-2 py-0.5 rounded-full">Approved</span></div>
            </div>
          </div>
      ...
      <button onClick={() => navigate("/deliverypartner/profile/settings")} className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold text-white bg-emerald-600 hover:bg-emerald-700 shadow-md shadow-emerald-600/20 transition-all">
