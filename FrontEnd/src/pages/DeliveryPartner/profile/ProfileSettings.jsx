...
export default function ProfileSettings() {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      ...
      navigate("/deliverypartner/profile");
    }, 800);
  };
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      <button onClick={() => navigate("/deliverypartner/profile")} className="flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 font-medium">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="p-5 border-t border-gray-100 flex gap-3">
          <button onClick={() => navigate("/deliverypartner/profile")} className="flex-1 px-4 py-2.5 rounded-xl text-sm font-semibold text-gray-600 bg-gray-50 hover:bg-gray-100 border border-gray-200 transition-all">
            Cancel
          </button>
