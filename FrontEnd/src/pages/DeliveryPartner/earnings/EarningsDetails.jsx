...
export default function EarningsDetails() {
  ...
  if (!txn) {
    return (
      <div className="flex flex-col items-center justify-center py-16">
        ...
        <button onClick={() => navigate("/deliverypartner/earnings")} className="mt-4 text-sm text-emerald-600 font-semibold hover:underline">Back to Earnings</button>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-lg mx-auto space-y-4">
      <button onClick={() => navigate("/deliverypartner/earnings")} className="flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 font-medium">
