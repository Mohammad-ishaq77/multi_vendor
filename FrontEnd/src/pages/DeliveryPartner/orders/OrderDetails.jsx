...
export default function OrderDetails() {
  ...
  if (!order) {
    return (
      <div className="flex flex-col items-center justify-center py-16">
        ...
        <button onClick={() => navigate("/deliverypartner/history")} className="mt-4 text-sm text-emerald-600 font-semibold hover:underline">Back to History</button>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      <button onClick={() => navigate("/deliverypartner/history")} className="flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 font-medium">
