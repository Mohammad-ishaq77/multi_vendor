    ...
    <div className="space-y-6">
      ...
      {filtered.length === 0 ? (
        ...
        <div className="space-y-3">
          {filtered.map((d) => (
            <motion.div key={d.id} whileHover={{ y: -1 }} className="bg-white rounded-xl border border-gray-100 p-4 shadow-sm cursor-pointer" onClick={() => navigate(`/deliverypartner/order/${d.id}`)}>
