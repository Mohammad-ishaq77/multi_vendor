...
export default function ActiveDeliveryCard({ delivery }) {
  ...
  const actionLabels = {
    accepted: { label: "Go to Pickup", path: "/deliverypartner/pickup" },
    pickup_verified: { label: "Confirm Pickup", path: "/deliverypartner/pickup-confirmed" },
    picked_up: { label: "Start Delivery", path: "/deliverypartner/pickup-confirmed" },
    out_for_delivery: { label: "Verify OTP", path: "/deliverypartner/verify" },
    otp_verified: { label: "Complete Delivery", path: "/deliverypartner/completed" },
  };
