    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-center justify-center py-16 bg-white rounded-2xl border border-gray-100">
          ...
          <button onClick={() => navigate("/deliverypartner/available")} className="mt-4 px-6 py-2.5 rounded-xl text-sm font-semibold text-white bg-emerald-600 hover:bg-emerald-700 shadow-md transition-all">
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900">Active Delivery</h1>
        <button
          onClick={() => { cancelDelivery(); navigate("/deliverypartner/available"); }}
