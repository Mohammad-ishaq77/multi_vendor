  ...
  if (!activeDelivery) {
    return (
      <div className="flex flex-col items-center justify-center py-16">
        ...
        <button onClick={() => navigate("/deliverypartner/active")} className="mt-4 text-sm text-emerald-600 font-semibold hover:underline">Go to Active Delivery</button>
      </div>
    );
  }
  ...
  const handleVerify = () => {
    ...
    setTimeout(() => {
      ...
      if (res.success) {
        ...
        setTimeout(() => navigate("/deliverypartner/pickup-confirmed"), 1200);
      } else {
