...
export default function DeliveryDetails() {
  ...
  if (!delivery) {
    return (
      <div className="flex flex-col items-center justify-center py-16">
        ...
        <button onClick={() => navigate("/deliverypartner/available")} className="mt-4 text-sm text-emerald-600 font-semibold hover:underline">Back to Available</button>
      </div>
    );
  }
  ...
  const handleAccept = () => {
    ...
    if (result.success) {
      ...
      navigate("/deliverypartner/active");
    } else {
