    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-center justify-center py-16 bg-white rounded-lg border border-gray-100">
          ...
          <button onClick={() => navigate("/delivery/available")} className="mt-4 px-6 py-2.5 rounded-md text-sm font-semibold text-white bg-emerald-600 hover:bg-emerald-700 shadow-md transition-all">
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="px-4 py-2 rounded-md text-sm font-semibold text-rose-600 bg-rose-50 hover:bg-rose-100 border border-rose-200 transition-all"
        >
          Cancel Delivery
        </button>
      </div>
