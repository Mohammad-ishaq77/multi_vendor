            ...
            <div className="space-y-2.5">
              {[
                ...
                <motion.div
                  ...
                  className="flex items-center gap-3 p-3 rounded-xl bg-[#F8FAFC] border border-gray-100"
                >
          ...
          <>
            ...
            <div className="text-center">
              <motion.div
                ...
                className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#1B4332] to-[#2D6A4F] flex items-center justify-center mx-auto mb-3 shadow-lg shadow-[#1B4332]/20"
              >
            ...
            <div className="space-y-2.5">
              {["Aadhaar Card", "Address Proof"].map((doc, i) => (
                <div key={doc} className="flex items-center gap-3 p-3 rounded-xl bg-[#F8FAFC] border border-gray-100">
            ...
            <motion.button
              ...
              disabled={verifying}
              className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-[#1B4332] to-[#2D6A4F] text-white py-3.5 rounded-xl font-semibold text-sm shadow-lg shadow-[#1B4332]/20 hover:from-[#143728] hover:to-[#1B4332] transition-all disabled:opacity-50"
            >
              {verifying ? (
                <>
