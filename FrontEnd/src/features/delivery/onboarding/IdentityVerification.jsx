        ...
        {verified ? (
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="space-y-3">
            <div className="text-center">
              ...
              <p className="mt-1 text-sm text-(--color-text-muted)">Aadhaar details were pulled from DigiLocker.</p>
            </div>
            {[
          ...
          <>
            <div className="text-center">
              ...
              <p className="mx-auto mt-1 max-w-xs text-sm text-(--color-text-muted)">
            ...
            {["Aadhaar Card", "Address proof from Aadhaar"].map((doc) => (
              <div key={doc} className="flex items-center gap-3 rounded-[12px] border border-[#edf3ef] bg-[#f8fbf9] p-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-[10px] bg-white text-(--color-text-muted)">
