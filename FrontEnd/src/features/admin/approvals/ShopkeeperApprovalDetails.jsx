    ...
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-bold text-gray-900">Shopkeeper Application</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <h3 className="text-sm font-semibold text-gray-900 mb-4 flex items-center gap-2">
            <User className="w-4 h-4 text-[#155c43]" />
            Owner Information
          </h3>
          <div className="space-y-4">
            ...
            <InfoRow icon={Calendar} label="Applied On" value={formatDate(approval.appliedAt)} />
          </div>
        </motion.div>
        ...
        >
          <h3 className="text-sm font-semibold text-gray-900 mb-4 flex items-center gap-2">
            <Store className="w-4 h-4 text-[#155c43]" />
            Shop Information
          </h3>
          <div className="space-y-4">
        ...
        >
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-blue-700 bg-blue-50 border border-blue-200 rounded-xl hover:bg-blue-100 transition-colors"
            >
      ...
      <ConfirmModal
        ...
        message="This will approve the application. The shopkeeper will be notified and can start listing products."
