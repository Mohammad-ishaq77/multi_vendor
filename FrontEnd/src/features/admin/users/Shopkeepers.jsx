              ...
              {filtered.map((user, i) => (
                <motion.div key={user.id} custom={i} variants={fadeUp} initial="hidden" animate="visible" className="p-4">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center mt-3">
                    <div className="bg-gray-50 rounded-xl p-2"><ShoppingBag className="w-3.5 h-3.5 text-gray-400 mx-auto mb-0.5" /><p className="text-xs font-medium text-gray-900">{user.totalOrders}</p><p className="text-[10px] text-gray-500">Orders</p></div>
                    <div className="bg-gray-50 rounded-xl p-2"><IndianRupee className="w-3.5 h-3.5 text-gray-400 mx-auto mb-0.5" /><p className="text-xs font-medium text-gray-900">₹{user.revenue?.toLocaleString()}</p><p className="text-[10px] text-gray-500">Revenue</p></div>
