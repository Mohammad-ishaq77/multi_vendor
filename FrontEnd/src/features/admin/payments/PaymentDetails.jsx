    ...
    <PageTransition>
      <div className="w-full space-y-6">
        <div className="flex items-center gap-3">
          <button onClick={() => navigate("/admin/payments")} className="w-10 h-10 rounded-md bg-white border border-gray-200 flex items-center justify-center text-gray-500 hover:text-[#155c43] hover:border-emerald-200 transition-all shadow-sm">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-lg border border-gray-100 p-6 shadow-sm space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-emerald-50 rounded-md"><span className="text-sm text-emerald-700">Product Amount → Shopkeeper</span><span className="text-sm font-bold text-emerald-800">₹{order.productAmount}</span></div>
            <div className="flex justify-between items-center p-3 bg-blue-50 rounded-md"><span className="text-sm text-blue-700">Delivery Fee → Partner (80%)</span><span className="text-sm font-bold text-blue-800">₹{order.partnerShare}</span></div>
            <div className="flex justify-between items-center p-3 bg-violet-50 rounded-md"><span className="text-sm text-violet-700">Delivery Fee → NearMart (20%)</span><span className="text-sm font-bold text-violet-800">₹{order.platformShare}</span></div>
        ...
        {/* Order Info */}
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }} className="bg-white rounded-lg border border-gray-100 p-5 shadow-sm space-y-3">
        ...
        {/* Delivery Partner */}
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="bg-white rounded-lg border border-gray-100 p-5 shadow-sm">
