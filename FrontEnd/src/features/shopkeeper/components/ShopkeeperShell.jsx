...
import ShopkeeperTopbar from "./ShopkeeperTopbar";
...
const ShopkeeperShell = ({ children }) => {
  ...
  return (
    <div className="flex h-screen min-h-screen overflow-hidden bg-[#f7faf8] font-sans selection:bg-[#155c43]/20 selection:text-[#155c43]">
      ...
      <ShopkeeperSidebar isMobileOpen={mobileMenuOpen} onMobileClose={closeMobileMenu} />
...
export default ShopkeeperShell;
